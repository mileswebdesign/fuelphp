...
class Driver_User extends Driver {
    
    /**
     * Adapter to \Autho\Acl
     *
     * @access  public
     * @var     object
     */
     ...
     * Usage:
     * 
     * <code>$role = \Autho\Auth::instance('user')->acl();
     ...
     * Usage:
     * 
     * <code>false === \Autho\Auth::instance('user')->is_logged()</code>
     *
     * @access  public
     * @return  bool
     */
     ...
     * Usage:
     * 
     * <code>$user = \Autho\Auth::instance('user')->get();</code>
     *
     * @access  public
     ...
     * Usage:
     * 
     * <code>\Autho\Auth::instance('user')->logout();</code>
     * 
     * @access  public
     * @return  bool
     */
